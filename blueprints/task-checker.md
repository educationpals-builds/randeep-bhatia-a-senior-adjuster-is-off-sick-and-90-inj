...
## Spec
One-paste spec: system instructions for the five-dial conversational task checker, with - **__desk_active_time_ms**: 178697
...
- **who_wants_it**: VP of Operations, covering for an adjuster on leave and unwilling to add overtime as calibration. Title the product after the learner's specimen, not a pack demo name.
