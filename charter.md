...
## Spec
Full audit grounded in the learner's specimen, standard, pasted inputs + source, check findings, severity story, call, tripwire — the builder's run. Open on the specimen domain, not a pack demo.
