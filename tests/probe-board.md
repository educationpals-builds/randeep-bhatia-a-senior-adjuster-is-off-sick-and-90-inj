...
## Spec
All probes with inputs, targeted checks, numeric invariants, expected behaviors, and this run's probe × check grid. Worked examples use the learner's failing inputs.
